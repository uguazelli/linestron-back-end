...
module.exports = Object.freeze({
	...
	ROOMS_UPDATE_BY_ID: `UPDATE Rooms SET name = ?, unique_name = ?, prefix = ? WHERE id = ?`,
	ROOMS_RESET_BY_ID: `UPDATE Rooms SET lastNumber=0, currentNumber=0 WHERE id=?`,
	...
	ROOMS_GET_LAST_BY_ROOM_ID: `SELECT c.id as 'companyId', c.name as 'companyName', c.slug as 'companySlug', r.id as 'roomId', r.name as 'roomName', r.unique_name as 'roomUniqueName', r.lastNumber as 'roomLastNumber', r.prefix FROM Companies c , Rooms r WHERE r.CompanyId = c.id and r.id = ?`,
